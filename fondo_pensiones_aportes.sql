...
--
-- Host: 127.0.0.1    Database: fondo_pensiones
-- ------------------------------------------------------
...
CREATE TABLE `aportes` (
  ...
  KEY `fk_afiliado` (`id_afiliado`),
  CONSTRAINT `fk_afiliado` FOREIGN KEY (`id_afiliado`) REFERENCES `afiliados` (`id_afiliado`)
...
-- Dump completed on 2025-12-05 18:49:01
